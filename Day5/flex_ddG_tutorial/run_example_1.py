...
rosetta_scripts_path = os.path.expanduser("/fastone/users/linchen/src/rosetta_bin_linux_2018.09.60072_bundle/main/source/bin/rosetta_scripts.static.linuxgccrelease")
